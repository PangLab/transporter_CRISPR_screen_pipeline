rule bwa_index:
        input:  os.path.join(output_dir,"reference/KO_align_reference.fasta")
        output: os.path.join(output_dir,"reference/KO_align_reference.fasta.bwt")
...
if "paired" in config:
    rule bwa_map:
        input:  R1=os.path.join(output_dir,"trimmed_reads/{sample}_R1.trim.fastq"), 
                ...
                refBWA=os.path.join(output_dir,"reference/KO_align_reference.fasta"), 
                refBWAi=os.path.join(output_dir,"reference/KO_align_reference.fasta.bwt")
